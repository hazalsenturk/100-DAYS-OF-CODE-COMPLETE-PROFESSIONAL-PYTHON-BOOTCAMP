...
def count_down(count):
    ...
    count_sec = count % 60
    if count_sec < 10:
        count_sec = f"0{count_sec}"  # used dynamic typing in here, available in python only
...
tomato_img = PhotoImage(data=tomato_img)
